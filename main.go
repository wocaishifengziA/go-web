...
import (
	"fmt"
	"log"
	"github.com/wocaishifengziA/go-web/pkg/errors"
)
...
func bindUser() error {
	if err := getUser(); err != nil {
		...
		return errors.Wrap(err, "encoding user 'Lingfei Kong' failed.")
	}
...
func queryDatabase() error {
	...
	return errors.New(1000, "user 'Lingfei Kong' not found.")
}
